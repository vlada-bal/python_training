...
def test_edit_contact(app):
    ...
    contact = Contact(firstname="Firskatze_", middlename="Middlekatze_", lastname="Lasthund_", nickname="Nickhund_",
                      ...
                      email="qw@qw.qw_", email2="we@we.we_", email3="er@er.er_", homepage="pagehome_", bday="21",
                      bmonth="February", byear="1918", aday="18",
                      amonth="July", ayear="1964", address2="kokokotown_", phone2="kokokohome_", notes="notes shmotes_")
