...
def test_add_empty_contact(app):
    ...
    app.contact_helper.creation(Contact(firstname="", middlename="", lastname="", nickname="", title="",
...
def test_add_contact(app):
    app.session.login(username="admin", password="secret")
    app.contact_helper.creation(Contact(firstname="Firskatze", middlename="Middlekatze", lastname="Lasthund", nickname="Nickhund",
                      title="Titlehamster",
