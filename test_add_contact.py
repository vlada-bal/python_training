...
from application_contacts import Application_con
...
def test_add_empty_contact(app):
    ...
    app.new_contact_creation(Group_contact(firstname="", middlename="", lastname="", nickname="", title="",
...
def test_add_contact(app):
    app.login(username="admin", password="secret")
    app.new_contact_creation(Group_contact(firstname="Firskatze", middlename="Middlekatze", lastname="Lasthund", nickname="Nickhund", title="Titlehamster",
